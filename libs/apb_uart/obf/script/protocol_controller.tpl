# protocol_controller
read_file ../../libs/protocol_controller/hdl/protocol_controller.v

parse_files +incdir+../../libs/protocol_controller/hdl \
            +incdir+../../inc \
...
write_design -flatten -munge -topmodule protocol_controller -out protocol_controller -outdir ../hdl_obf
write_design -flatten        -topmodule protocol_controller -out protocol_controller -outdir ../hdl_obf_kname

report_blackbox -topmodule protocol_controller -blackbox
