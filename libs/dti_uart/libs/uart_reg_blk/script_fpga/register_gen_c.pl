...
=======
        print $register_fh "  reg_";print $register_fh ""."$reg_array[$reg_index]{'reg_name'}"."$name_ext";print $register_fh ".reg_data = (reg_";
        print $register_fh ""."$reg_array[$reg_index]{'reg_name'}"."$name_ext";print $register_fh ".reg_data & ~field->mask) \n";
>>>>>>> .r4018
...
=======
        print $register_fh ""."$reg_array[$reg_index]{'reg_name'}"."$name_ext";print $register_fh ".reg_data & field->mask) >> field->offset; \n";
>>>>>>> .r4018
        print $register_fh "} \n";
...
=======
        print $register_fh ", reg_";print $register_fh ""."$reg_array[$reg_index]{'reg_name'}"."$name_ext";print $register_fh ".reg_data);\n";
>>>>>>> .r4018
        print $register_fh "} \n";
...
=======
        print $register_fh "  read_reg(ADDR_REG_";print $register_fh uc""."$reg_array[$reg_index]{'reg_name'}"."$name_ext";print $register_fh ", &reg_";print $register_fh ""."$reg_array[$reg_index]{'reg_name'}"."$name_ext";print $register_fh ".reg_data);\n";
>>>>>>> .r4018
