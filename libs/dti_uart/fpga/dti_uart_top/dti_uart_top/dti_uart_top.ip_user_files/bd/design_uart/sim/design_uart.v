...
(* CORE_GENERATION_INFO = "design_uart,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_uart,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=18,numReposBlks=13,numNonXlnxBlks=1,numHierBlks=5,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_board_cnt=1,da_mb_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "design_uart.hwdef" *) 
module design_uart
   (clk_in1,
    cts_n_0,
    resetn,
    ...
    usb_uart_rxd,
    usb_uart_txd);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_IN1 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_IN1, CLK_DOMAIN design_uart_clk_in1_0, FREQ_HZ 100000000, PHASE 0.000" *) input clk_in1;
  input cts_n_0;
  ...
  input rx_0;
  output tx_0;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 usb_uart CTSn" *) input usb_uart_ctsn;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 usb_uart RTSn" *) output usb_uart_rtsn;
  ...
  assign axi_uart16550_0_UART_CTSn = usb_uart_ctsn;
  assign axi_uart16550_0_UART_RxD = usb_uart_rxd;
  assign clk_in1_0_1 = clk_in1;
  assign cts_n_0_1 = cts_n_0;
  assign reset_0_1 = resetn;
  assign rts_n_0 = dti_uart_0_rts_n;
  assign rx_0_1 = rx_0;
  assign tx_0 = dti_uart_0_tx;
  assign usb_uart_rtsn = axi_uart16550_0_UART_RTSn;
  assign usb_uart_txd = axi_uart16550_0_UART_TxD;
  design_uart_axi_apb_bridge_0_0 axi_apb_bridge_0
  ...
  design_uart_axi_interconnect_0_0 axi_interconnect_0
  ...
  design_uart_axi_uart16550_0_0 axi_uart16550_0
  ...
  design_uart_clk_wiz_1_0 clk_wiz_1
       (.clk_cpu(microblaze_0_Clk),
        .clk_in1(clk_in1_0_1),
        .clk_uart(clk_wiz_1_clk_uart),
        .locked(clk_wiz_1_locked),
        .resetn(reset_0_1));
  design_uart_dti_uart_0_0 dti_uart_0
       (.clk(clk_wiz_1_clk_uart),
        .cts_n(cts_n_0_1),
        .paddr(axi_apb_bridge_0_APB_M_PADDR[11:0]),
        .pclk(microblaze_0_Clk),
        .penable(axi_apb_bridge_0_APB_M_PENABLE),
        .prdata(axi_apb_bridge_0_APB_M_PRDATA),
        .pready(axi_apb_bridge_0_APB_M_PREADY),
        .presetn(rst_clk_wiz_1_100M_peripheral_aresetn),
        ...
        .reset_n(rst_clk_wiz_1_100M_peripheral_aresetn),
        .rts_n(dti_uart_0_rts_n),
        .rx(rx_0_1),
        .tx(dti_uart_0_tx));
  design_uart_mdm_1_0 mdm_1
  ...
  design_uart_rst_clk_wiz_1_100M_0 rst_clk_wiz_1_100M
       (.aux_reset_in(1'b1),
...
module design_uart_axi_interconnect_0_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  m00_couplers_imp_1Y546N3 m00_couplers
  ...
  m01_couplers_imp_RHKBGH m01_couplers
       (.M_ACLK(axi_interconnect_0_ACLK_net),
        .M_ARESETN(axi_interconnect_0_ARESETN_net),
  ...
  s00_couplers_imp_4NPLLB s00_couplers
       (.M_ACLK(axi_interconnect_0_ACLK_net),
        .M_ARESETN(axi_interconnect_0_ARESETN_net),
...
module m00_couplers_imp_1Y546N3
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m01_couplers_imp_RHKBGH
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module microblaze_0_local_memory_imp_UXHIJP
  ...
  (* KEEP_HIERARCHY = "yes" *) 
  design_uart_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  design_uart_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_dlmb_bus_BE),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  design_uart_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  design_uart_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_0_ilmb_bus_BE),
        ...
        .Sl_UE(microblaze_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_0_ilmb_bus_WAIT));
  design_uart_lmb_bram_0 lmb_bram
...
module s00_couplers_imp_4NPLLB
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
