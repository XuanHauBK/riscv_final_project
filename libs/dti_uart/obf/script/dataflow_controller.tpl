# Dataflow Controller
read_file ../../libs/dataflow_controller/hdl/dataflow_controller.v

parse_files +incdir+../../libs/dataflow_controller/hdl \
            +incdir+../../inc \
...
write_design -flatten -munge -topmodule dataflow_controller -out dataflow_controller -outdir ../hdl_obf
write_design -flatten        -topmodule dataflow_controller -out dataflow_controller -outdir ../hdl_obf_kname

report_blackbox -topmodule dataflow_controller -blackbox
