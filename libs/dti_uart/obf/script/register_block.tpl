# register_block
read_file ../../libs/register_block/hdl/register_block.sv

parse_files +incdir+../../libs/register_block/hdl \
            +incdir+../../inc \
...
write_design -flatten -munge -topmodule register_block -out register_block -outdir ../hdl_obf
write_design -flatten        -topmodule register_block -out register_block -outdir ../hdl_obf_kname
