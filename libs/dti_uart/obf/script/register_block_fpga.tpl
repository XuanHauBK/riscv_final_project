# register_block_fpga
read_file ../../libs/register_block_fpga/hdl/register_block.sv

parse_files +incdir+../../libs/register_block_fpga/hdl \
            +incdir+../../inc \
...
write_design -flatten -munge -topmodule register_block -out register_block -outdir ../hdl_obf_fpga
write_design -flatten        -topmodule register_block -out register_block -outdir ../hdl_obf_fpga_kname

report_blackbox -topmodule register_block -blackbox
