###############################################################################################################################
# Datapath
read_file ../../libs/datapath/hdl/datapath.v

parse_files +incdir+../../libs/datapath/hdl \
            +incdir+../../inc \
...
write_design -flatten -munge -topmodule datapath -out datapath -outdir ../hdl_obf
write_design -flatten        -topmodule datapath -out datapath -outdir ../hdl_obf_kname

report_blackbox -topmodule datapath -blackbox
