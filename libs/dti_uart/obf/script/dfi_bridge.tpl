# dfi_bridge
read_file ../../libs/dfi_bridge/hdl/dfi_bridge.v

parse_files +incdir+../../libs/dfi_bridge/hdl \
            +incdir+../../inc \
...
write_design -flatten -munge -topmodule dfi_bridge -out dfi_bridge -outdir ../hdl_obf
write_design -flatten        -topmodule dfi_bridge -out dfi_bridge -outdir ../hdl_obf_kname

report_blackbox -topmodule dfi_bridge -blackbox
