...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=15,numReposBlks=14,numNonXlnxBlks=2,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_board_cnt=3,da_clkrst_cnt=3,da_mb_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (clk_in1,
    ctsn,
    gpio_in,
  ...
  wire clk_wiz_0_clk_uart;
  wire clk_wiz_0_locked;
  wire ctsn_1;
  wire [15:0]dti_riscv_0_gpio_o;
  wire dti_riscv_0_rts_n;
  wire dti_riscv_0_rts_n_boost;
  wire dti_riscv_0_tx;
  wire dti_uart_0_boost_en;
  wire dti_uart_0_tx;
  wire [15:0]gpio_in_1;
  ...
  assign gpio_out[15:0] = dti_riscv_0_gpio_o;
  assign resetn_1 = resetn;
  assign rtsn = dti_riscv_0_rts_n;
  assign rx_1 = rx;
  assign tx = dti_riscv_0_tx;
  ...
  design_1_clk_wiz_0_0 clk_wiz_0
       (.clk_cpu(clk_wiz_0_clk_cpu),
        .clk_in1(clk_in1_1),
        .clk_uart(clk_wiz_0_clk_uart),
        .locked(clk_wiz_0_locked),
        .resetn(resetn_1));
  design_1_dti_riscv_0_0 dti_riscv_0
       (.apb_pclk(clk_wiz_0_clk_cpu),
        .apb_presetn(rst_clk_wiz_0_100M_peripheral_aresetn),
        .boost_en(dti_uart_0_boost_en),
        .clk(clk_wiz_0_clk_cpu),
        .clk_uart(clk_wiz_0_clk_uart),
        .cts_n(ctsn_1),
        .gpio_i(gpio_in_1),
        .gpio_o(dti_riscv_0_gpio_o),
        .reset_n(rst_clk_wiz_0_100M_peripheral_aresetn),
        .rts_n(dti_riscv_0_rts_n),
        .rts_n_boost(dti_riscv_0_rts_n_boost),
        .rx(rx_1),
        .rx_boost(dti_uart_0_tx),
        .tx(dti_riscv_0_tx));
  design_1_dti_uart_0_1 dti_uart_0
       (.boost_en(dti_uart_0_boost_en),
        .clk(clk_wiz_0_clk_cpu),
        .cts_n(dti_riscv_0_rts_n_boost),
        .paddr(axi_apb_bridge_0_APB_M_PADDR[11:0]),
        .pclk(clk_wiz_0_clk_cpu),
        .penable(axi_apb_bridge_0_APB_M_PENABLE),
        .prdata(axi_apb_bridge_0_APB_M_PRDATA),
        .pready(axi_apb_bridge_0_APB_M_PREADY),
        .presetn(rst_clk_wiz_0_100M_peripheral_aresetn),
        .psel(axi_apb_bridge_0_APB_M_PSEL),
        .pslverr(axi_apb_bridge_0_APB_M_PSLVERR),
        .pstrb(xlconstant_0_dout),
        .pwdata(axi_apb_bridge_0_APB_M_PWDATA),
        .pwrite(axi_apb_bridge_0_APB_M_PWRITE),
        .reset_n(rst_clk_wiz_0_100M_peripheral_aresetn),
        .rx(xlconstant_1_dout),
        .tx(dti_uart_0_tx));
  ...
  design_1_rst_clk_wiz_0_100M_0 rst_clk_wiz_0_100M
       (.aux_reset_in(1'b1),
        ...
        .slowest_sync_clk(clk_wiz_0_clk_cpu));
